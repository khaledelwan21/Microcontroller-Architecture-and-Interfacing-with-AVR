...
/*
 Options:-
 	 1-ADC_TRIGGER_FREE_RUNNING                                
 	 2-ADC_TRIGGER_ANALOG_COMPARATOR
 	 3-ADC_TRIGGER_EXT_INT0         
 	 4-ADC_TRIGGER_TIMER0_COMPA         
 	 5-ADC_TRIGGER_TIMER0_OVF       
 	 6-ADC_TRIGGER_TIMER1_COMPB     
 	 7-ADC_TRIGGER_TIMER1_OVF       
 	 8-ADC_TRIGGER_TIMER1_CAPT                                                      

 */

#define ADC_TRIGGERING_SOURCE   ADC_TRIGGER_FREE_RUNNING
